...
<script>	// begin backbone.js testing

/*
(function ($) {
	window.Pop = Backbone.View.extend({
	  el: $('.individual_container'),
	  events: {
	    "hover img":  "image_pop()",
	  }
	});
...
//	rewriting featured display function
(function ($) {
	...
	Featured_Bands = Backbone.Collection.extend({
