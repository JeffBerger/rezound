...
//		target.children('.individual_container').hide("slide", {direction:arrow_dir}, 100);
		...
		for(var i=0; i<list.length; i++)	// redisplay items
		{
			target.append('<div class="individual_container" style=width:150px;height:100%;margin:20px;float:left>	<div class="text_box_top" style=width:100%;height:45px>	<center>	<span class="poptext" hidden>' + list[i][0] +'</span>	</center>	</div> 	<div class="image_box" style=width:100%;height:150px>	<img class="popoutmedia" src=' + list[i][1] + ' width=150px height=150px />	</div> 	<div class="text_box_bottom" style=width:100%;height:105px>	<center>	<br><span class="poptext" hidden><b>Latest Release:  </b>' + list[i][2] + '</span>	</center>	</div>	</div>');
		}
